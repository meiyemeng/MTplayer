...
import com.fongmi.android.tv.ui.dialog.MembershipDialog;
...
public class SettingFragment extends BaseFragment implements ConfigListener, SiteListener, LiveListener, ThemeDialog.Listener {
    ...
    protected void initEvent() {
        ...
        mBinding.membership.setOnClickListener(this::onMembership);
    ...
    private void onMembership(View view) {
        MembershipDialog.show(requireActivity());
    }
