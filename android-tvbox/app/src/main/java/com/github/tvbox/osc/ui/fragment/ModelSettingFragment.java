...
import com.github.tvbox.osc.ui.activity.MembershipActivity;
...
public class ModelSettingFragment extends BaseLazyFragment {
    ...
    protected void init() {
        ...
        findViewById(R.id.llMembership).setOnClickListener(v -> startActivity(new Intent(mContext, MembershipActivity.class)));
